                ...
                <nav class="navbar navbar-expand-lg">
                    <div id='imgdiv'>
                        <ul class="nav navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#cht" data-toggle="tab"><img
                                        src="img\fronted\buy\CHT.png"></a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div id="jkoleftdiv">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><input type="radio" name="price" id="jko1000"
                                                        value="1000,3500"><label for="jko1000">NT$1000</label></td>
                                                <td><label for="jko1000">遊戲幣 × 3500</label></td>
                                            </tr>
                                            <tr>
                                                <td><input type="radio" name="price" id="jko2500"
                                                        value="2500,8000"><label for="jko2500">NT$2500</label></td>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    ...
                                                    <button class="btn btn-primary btn-lg btn-block  "
                                                        data-toggle="button" id="confirm" disabled>確認</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div style="width:50%;float:left;padding:20px">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><input type="radio" name="price" id="cht1000"
                                                        value="1000,3500"><label for="cht1000">NT$ 1000</label></td>
                                                <td><label for="cht1000">遊戲幣 × 3500</label></td>
                                            </tr>
                                            <tr>
                                                <td><input type="radio" name="price" id="cht2500"
                                                        value="2500,8000"><label for="cht2500">NT$ 2500</label></td>
                                                ...
                                                <td colspan="2">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <div class="input-group-append">
                                                                <button class="btn btn-outline-secondary" type="button"
                                                                    id="button-addon2">傳送驗證碼</button>
                                                            </div>
                                                        </div>
                                                        <small id="emailHelp"
                                                            class="form-text text-muted">將傳送簡訊驗證碼至您所輸入的手機</small>
                                                    </div>
                                                    ...
                                                    <label>
                                                        ...
                                                        <div class="input-group mb-3 ">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="validationDefault01" placeholder="驗證碼"
